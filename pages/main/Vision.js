export default function Vision(){
    return(
      ...
      <div className="grid max-w-4xl grid-cols-1 p-2 mx-auto rounded-lg shadow-xl lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2 ">
          <div className="relative flex flex-col-reverse col-start-1 row-start-1 p-3 rounded-lg bg-gradient-to-t from-black/75 via-black/0 sm:bg-none sm:row-start-2 sm:p-0 lg:row-start-1">
            <h1 className="mt-1 text-lg font-black text-white sm:text-gray-900 md:text-2xl">Our Vision</h1>
          ...
          <p className="col-start-1 mt-4 text-lg leading-6 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1">
