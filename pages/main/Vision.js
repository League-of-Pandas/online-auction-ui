      ...
      <div className="grid max-w-4xl grid-cols-1 mx-auto lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2 ">
          ...
          {/* <dl className="mt-4 text-xs font-medium flex items-center row-start-2 sm:mt-1 sm:row-start-3 md:mt-2.5 lg:row-start-2" >
            ...
            <dd className="flex items-center text-indigo-600">
              <svg width="24" height="24" fill="none" aria-hidden="true" className="mr-1">
                <path d="m12 5 2 5h5l-4 4 2.103 5L12 16l-5.103 3L9 14l-4-4h5l2-5Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <span>4.89 <span className="font-normal text-gray-400">(128)</span></span>
            </dd>
            ...
            <dd className="flex items-center">
              ...
              <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-1" aria-hidden="true">
